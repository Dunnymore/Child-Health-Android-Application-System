...
public class Remindersetup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vaccinationButton.setOnClickListener(v -> {
            Intent intent = new Intent(Remindersetup.this, VaccinationHome.class);
        ...
        doctorAppointmentButton.setOnClickListener(v -> {
            Intent intent = new Intent(Remindersetup.this, DoctorsAppointment.class);
            startActivity(intent);
        });
        ...
        medicationReminderButton.setOnClickListener(v -> {
            Intent intent = new Intent(Remindersetup.this, Medication.class);
            startActivity(intent);
        });
        ...
        reminderSetupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Remindersetup.this,
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                                ...
                                TimePickerDialog timePickerDialog = new TimePickerDialog(Remindersetup.this,
